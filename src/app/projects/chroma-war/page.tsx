...
export default function ChromaWar() {
  ...
  return (
    <div className="flex flex-col items-center w-full h-fit font-light overflow-x-hidden">
      ...
      >
        {
          orientation === "landscape" ? <TextRandomizerEffect className="text-4xl text-header font-semibold" words="The Dev's Story Behind Chroma War" delay={40} /> : <h1 className="text-4xl font-semibold">The Dev&apos;s Story Behind Chroma War</h1>
        }
